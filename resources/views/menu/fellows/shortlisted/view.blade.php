                            ...
                            @foreach ($fellows as $key => $fellow)
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="form-check
                                            {{ $fellow->shortlisted == 1 ? 'form-switch' : '' }}">
                                            <button
                                                class="btn 
                                        ...
                                        <div
                                            ...
                                            <button
                                             ...
                                             btn-sm"
                                                id="shortlist"
                                                onclick="
                                                {{ $fellow->selected == 1 ? 'notSelect(' . $fellow->id . ')' : 'select(' . $fellow->id . ')' }}
                                                ">
                                    ...
                                    <td>
                                        <div>
                                            <a class="btn btn-primary btn-sm"
                                                href="{{ route('shortlisted-fellow-details', $fellow->id) }}">
                                                <i class="ri-eye-fill"></i>
                                            </a>
                                            <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#delete{{ $key }}">
                                ...
                                {{ $fellow->shortlisted == 1 ? 'text-success' : 'text-danger' }}"
                                    id="delete{{ $key }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('delete-fellow', $fellow->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
