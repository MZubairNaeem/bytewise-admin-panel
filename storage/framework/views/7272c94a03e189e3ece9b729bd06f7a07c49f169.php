...
<style>
    ...
    .card {
        box-shadow: 0 4px 8px 0 #12316b, 0 6px 20px 0 #12316b !important;
    }
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <h1 class="fs-36 text-white">Bytewise</h1>
                                </a>
                            </div>
                            <p class="mt-3 fs-15 ">Admin Panel</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 style="color: #12316b">Welcome Back !</h5>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('email', 'uhk@bytewise.com')); ?>" id="username" name="email"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mt-4">
                                                <button  class="btn custom-btn w-100 " type="submit">Sign In</button>
                                            </div>
                                    </form>
                                </div>
                            </div>
