            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <div class="col">
                        ...
                        <div>
                            <?php echo $__env->make('partials.session-apply', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>

                    </div>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('submitform')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
