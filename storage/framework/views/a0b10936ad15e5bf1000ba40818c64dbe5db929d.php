                    ...
                    <div class="mt-3">
                        <div>
                            ...
                            <button
                                ...
                                id="shortlist"
                                onclick="
                                                <?php echo e($fellow->selected == 1 ? 'notSelect(' . $fellow->id . ')' : 'openModal()'); ?>
                    ...
                    <div id="select" class="modal fade zoomIn" tabindex="-1" aria-labelledby="select" aria-hidden="true"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="<?php echo e(route('selected-fellow', $fellow->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\Bytewise\interactive\resources\views/menu/fellows/shortlisted/detail.blade.php ENDPATH**/ ?>