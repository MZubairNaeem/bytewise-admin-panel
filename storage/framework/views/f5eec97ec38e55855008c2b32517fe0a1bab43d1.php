        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1"><?php echo e($track->name); ?></h5>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div>
                                            <a class="btn btn-primary btn-sm"
                                                href="<?php echo e(route('shortlisted-fellow-details', $fellow->id)); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\Bytewise\interactive\resources\views/menu/track/view.blade.php ENDPATH**/ ?>